...
<?php endif ?>        
  ...
  <div class="copyright">
	 <a href="http://p4pms" target="_blank">p4pms <?php echo sfConfig::get('app_qdpm_version') ?></a> <br> Copyright &copy; <?php echo  date('Y') ?> <a href="http://p4pms" target="_blank">p4pms</a>
  </div>
