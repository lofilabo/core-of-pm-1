...
<?php
  ...
  $hmtl = '
    ...
    <table style="margin: 5px 0;" class="contentTable">
      ...
      <tr>      
        <td>
        <input class="yuimenecheckbox" name="search[in_description]" ' . (isset($search['in_description']) ? 'checked="checked"':'') .  ' type="checkbox" id="search_in_description"> <label for="search_in_description">' . __('Description') . '</label></br>
        <input class="yuimenecheckbox" name="search[in_comments]" ' . (isset($search['in_comments']) ? 'checked="checked"':'') .  ' type="checkbox" id="search_in_comments"> <label for="search_in_comments">' . __('Comments') . '</label><br>
