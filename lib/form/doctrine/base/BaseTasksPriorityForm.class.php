...
/**
 * TasksPriority form base class.
 *
 * @method TasksPriority getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseTasksPriorityForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('tasks_priority[%s]');
